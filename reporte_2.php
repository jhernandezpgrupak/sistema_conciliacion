...
<?php
$a = unserialize(stripslashes($_POST['vector_5']));
$a2 = unserialize(stripslashes($_POST['vector_6']));
$a3 = unserialize(stripslashes($_POST['vector_7']));
$a4 = unserialize(stripslashes($_POST['vector_8']));
$suma=0;
...
<table border=1 width='689' height='20'><tr><td><br><center>Cargos de la Entidad no correspondidos por el Banco</center><br></td></tr></table><br></br>
...
$pdf = $dompdf->output();
$filename = "Cargos_de_la_entidad_no_correspondidos_por_el_banco".time().'.pdf';
