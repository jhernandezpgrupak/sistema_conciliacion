...
<?php
$a = unserialize(stripslashes($_POST['vector_13']));
$a2 = unserialize(stripslashes($_POST['vector_14']));
$a3 = unserialize(stripslashes($_POST['vector_15']));
$a4 = unserialize(stripslashes($_POST['vector_16']));
$suma=0;
...
<table border=1 width='689' height='20'><tr><td><br><center>Abonos de la Entidad no correspondidos por el Banco</center><br></td></tr></table><br></br>
...
$pdf = $dompdf->output();
$filename = "Abonos_de_la_entidad_no_correspondidos_por_el_banco".time().'.pdf';
